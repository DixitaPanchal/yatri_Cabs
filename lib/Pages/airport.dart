...
class Airport extends StatefulWidget {
  ...
  @override
  State<Airport> createState() => _RoundTripState();
}

class _RoundTripState extends State<Airport> {
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Airport Transfer", style: AppWidget.SimpleText1(),),
                ...
                child: Column(
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        Button(txt: "To the Airport", btnclr: false, height2: 28,border: false,),
                        SizedBox(width: 10,),
                        Button(txt: "From the Airport", btnclr: true, height2: 28, border: true),

                      ],
                    ),
                    SizedBox(height: 10,),
                    PickUpCityContainers("assets/locationMap.png", "Pickup Airport", "Type City Name", context),
                    SizedBox(height: 10,),
